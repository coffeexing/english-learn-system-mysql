...
CREATE TABLE `english_book` (
  ...
  `base_practice_num` INTEGER DEFAULT NULL,
  `translate_practice_num` INTEGER DEFAULT NULL,
  `exam_num` INTEGER DEFAULT NULL
);
...
CREATE TABLE `english_word` (
  ...
  `word_type` INTEGER DEFAULT NULL,
  `word` TEXT NOT NULL,
  `chinese` TEXT NOT NULL,
  `pronounce_file` TEXT DEFAULT NULL,
  `description` text,
  `status` INTEGER NOT NULL
);
...
CREATE TABLE `exam_score` (
  ...
  `answer_true` INTEGER DEFAULT NULL
);
