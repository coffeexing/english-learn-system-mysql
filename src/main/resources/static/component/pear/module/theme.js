layui.define(["jquery", "layer"], function (exports) {
    ...
    theme.changeTheme = function (target, autoHead) {
        ...
        const titleColor = localStorage.getItem("title-color-context");
        this.colorSet(color, titleColor);
    ...
    theme.colorSet = function (color, titleColor) {
        ...
        style += '.pear-admin .layui-logo .title{color:' + titleColor + '!important;}';
