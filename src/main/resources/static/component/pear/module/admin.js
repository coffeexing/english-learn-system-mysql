    ...
    function (exports) {
        ...
        const pearAdmin = new function () {
            ...
            this.themeRender = function (option) {
                ...
                // 整体主题色
                let colorId = localStorage.getItem("theme-color");
                if (colorId === null) {
                    const currentColor = getColorById(option.theme.defaultColor);
                ...
                this.menuSkin(menu);
                // 标题主题色
                let titleColor = localStorage.getItem("title-color-context");
                if (titleColor === null) {
                    titleColor = option.theme.titleColor;
                    localStorage.setItem("title-color-context", titleColor);
                }
                // 主题变更
            ...
            this.menuSkin = function (theme) {
                ...
                pearAdmin.removeClass('routine-theme');
        ...
        body.on("click", ".setting", function () {
            ...
            bgColorHtml +=
                '<li  data-select-bgcolor="routine-theme" >' +
                '<a href="javascript:;" data-skin="skin-blue" style="" class="clearfix full-opacity-hover">' +
                '<div><span style="display:block; width: 20%; float: left; height: 12px; background: #1d4978;"></span><span style="display:block; width: 80%; float: left; height: 12px; background: #1d4978;"></span></div>' +
                '<div><span style="display:block; width: 20%; float: left; height: 40px; background: #1d4978;"></span><span style="display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;"></span></div>' +
                '</a>' +
                '</li>';
