 ...
 *
  ...
  function MyController($scope, $http) {
    ...
    $http.get('/secure.py').success(function(data, status, headers) {
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       beforeEach(inject(function($injector) {
         ...
         $httpBackend.when('GET', '/secure.py').respond({userId: 'userX'}, {'A-Token': 'xxx'});
       ...
       it('should fetch authentication token', function() {
         $httpBackend.expectGET('/secure.py');
       ...
       it('should send secure header', function() {
         var controller = createController();
         $httpBackend.flush();
